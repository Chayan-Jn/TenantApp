  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-950 px-4 transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-8 transition-colors">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 transition-colors">Create an account</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-6 transition-colors">Start managing your properties</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
            />
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 transition-colors">Min 8 chars, uppercase, lowercase, number, special char</p>
          </div>
        ...
        <div className="relative flex items-center py-6">
          ...
          <span className="shrink-0 mx-4 text-gray-400 dark:text-gray-500 text-sm transition-colors">Or sign up with</span>
          <div className="grow border-t border-gray-200 dark:border-slate-700 transition-colors"></div>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400 transition-colors">
          ...
          <Link to="/login" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors">Sign in</Link>
        </p>
      </div>
    </div>
  )
