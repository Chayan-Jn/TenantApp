...
const router = createBrowserRouter([
  // ── Homepage at root — no auth required, no redirect ──
  {
    path: "/",
    lazy: () =>
      import("./pages/home/Home.jsx").then((m) => ({ Component: m.default })),
  ...
  },
  {
    path: "/login",
    lazy: () =>
      import("./pages/auth/Login.jsx").then((m) => ({ Component: m.default })),
    errorElement: <GlobalError />,
    loader: guestLoader,
  },
  {
  ...
  // ── Auth-protected app routes ──
  {
    ...
    children: [
      ...
      },
      {
        path: "properties/:id",
        lazy: () =>
          import("./pages/properties/PropertyDetail.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async ({ params }) => {
      ...
      },
      {
        path: "units/:id",
        lazy: () =>
          import("./pages/units/UnitDetail.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async ({ params }) => {
      ...
      },
      {
        path: "tenants/:id",
        lazy: () =>
          import("./pages/tenants/TenantDetail.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async ({ params }) => {
      ...
      },
      {
        path: "rent/overdue",
        lazy: () =>
          import("./pages/rent/Overdue.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async () => {
      ...
      },
      {
        path: "payments",
        lazy: () =>
          import("./pages/payments/Payments.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async () => {
          const { getProperties } = await import("./api/property.api.js");
      ...
      },
      {
        ...
        lazy: () =>
          import("./pages/properties/PropertyTenants.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async ({ params }) => {
          const { getTenants } = await import("./api/tenant.api.js");
      ...
      },
      {
        path: "bills",
        lazy: () =>
          import("./pages/bills/Bills.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async () => {
          const { getProperties } = await import("./api/property.api.js");
      ...
      },
      {
        path: "reports",
        lazy: () =>
          import("./pages/reports/Reports.jsx").then((m) => ({
            Component: m.default,
          })),
        loader: async () => {
          const { getProperties } = await import("./api/property.api.js");
          ...
          try {
            ...
            const merged = (properties.data || []).map((p) => {
              ...
              return {
                ...p,
                total_units: dp?.total_units || 0,
                occupied_units: dp?.occupied_units || 0,
              };
            });
    ...
    children: [
      {
        path: "privacy-policy",
        lazy: () =>
          import("./pages/legal/PrivacyPolicy.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "terms",
        lazy: () =>
          import("./pages/legal/TermsOfService.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "refund-policy",
        lazy: () =>
          import("./pages/legal/RefundPolicy.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
      ...
      {
        path: "features/rent-ledger",
        lazy: () =>
          import("./pages/features/RentLedger.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "features/bill-splitting",
        lazy: () =>
          import("./pages/features/BillSplitting.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "features/tenant-tracking",
        lazy: () =>
          import("./pages/features/TenantTracking.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "features/auto-signatures",
        lazy: () =>
          import("./pages/features/AutoSignatures.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
...

      {
        ...
        lazy: () =>
          import("./pages/research/GreenPremiums.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/tenant-retention",
        lazy: () =>
          import("./pages/research/TenantRetention.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/smart-management",
        lazy: () =>
          import("./pages/research/SmartManagement.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/behavioral-rent",
        lazy: () =>
          import("./pages/research/BehavioralRent.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/maintenance-roi",
        lazy: () =>
          import("./pages/research/MaintenanceROI.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/utility-billing",
        lazy: () =>
          import("./pages/research/UtilityBilling.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/rent-determinants",
        lazy: () =>
          import("./pages/research/RentDeterminants.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/landlord-economics",
        lazy: () =>
          import("./pages/research/LandlordEconomics.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/eviction-costs",
        lazy: () =>
          import("./pages/research/EvictionCosts.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        path: "research/digital-transformation",
        lazy: () =>
          import("./pages/research/DigitalTransformation.jsx").then((m) => ({
            Component: m.default,
          })),
      },

      {
        ...
        lazy: () =>
          import("./pages/tools/RentCalculator.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        ...
        lazy: () =>
          import("./pages/tools/CapRateCalculator.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        ...
        lazy: () =>
          import("./pages/tools/ROICalculator.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        ...
        lazy: () =>
          import("./pages/tools/CostSegregation.jsx").then((m) => ({
            Component: m.default,
          })),
      },
      {
        ...
        lazy: () =>
          import("./pages/tools/1031Exchange.jsx").then((m) => ({
            Component: m.default,
          })),
      },
    ],
